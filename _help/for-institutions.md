...
1. Read this and [What is OpenRiC?](/help/what-is-openric/).
2. Browse the live [reference deployment](https://ric.theahg.co.za/) and the [viewer](https://viewer.openric.org/).
3. Have a developer run the [conformance probe](/help/conformance-and-profiles/) against a prototype.

## In a procurement conversation

Ask vendors whether they can pass the **OpenRiC conformance probe**, and which [profiles](/help/profiles-tree/) they support. Their answer is a strong signal of their standards orientation. There is a fuller [institutional brief](/for-institutions.html) on the main site.

## Next

- [What is OpenRiC?](/help/what-is-openric/)
